...
../src/assemblmore_pipeline.sh --help | head -20

echo ""
echo "=== Testing with custom parameters ==="
echo "Command that would be executed:"
echo "../src/assemblmore_pipeline.sh -t 10000 -l 5000 -q 30 -v ref.fasta asm.fasta reads.fasta"

echo ""
echo "=== Testing argument validation ==="
if ../src/assemblmore_pipeline.sh -t 10000 2>&1 | grep -q "ERROR: Exactly 3 positional arguments required"; then
...
if ../src/assemblmore_pipeline.sh --unknown-option 2>&1 | grep -q "ERROR: Unknown option"; then
