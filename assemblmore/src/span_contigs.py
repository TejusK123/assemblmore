        ...
        for iteration in range(max_iterations):
            ...
            if iteration < max_iterations - 1 and enable_extension:
                ...
                if not extension_candidates.empty:
                    ...
                    cleaned_reads_file = os.path.basename(reads_file).replace('.fasta', '')
                    cleaned_reads_file = cleaned_reads_file.replace('.fna', '')  # Remove .fna extension for consistency
                    cleaned_reads_file = cleaned_reads_file.replace('.fastq', '')  # Remove .fastq extension for consistency
                    cleaned_reads_file = cleaned_reads_file.replace('.fa', '')  # Remove .fa extension for consistency
